            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="collapse" id="trainDetails{{ $train->trainid }}">
                    <div class="card-body p-2">
                        ...
                        <div class="row g-4">
                            @foreach ($trainMap[$train->trainid] ?? [] as $compartmenttype => $compartment)
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <span class="badge bg-primary rounded-pill">
                                                {{ $compartment['available_seats'] }} Seats
                                            </span>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-end">
                                            ...
                                            <form method="GET" action="{{ route('passenger.traininfosubmission') }}">
                                                ...
                                                <input type="hidden" name="direction" value="{{ $compartment['direction'] }}">
                                                
                                                @if($compartment['available_seats'] > 0)
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    It consists of multiple compartments, including 
                    <span id="info-compartmentnumber"></span> compartments designed to accommodate passengers comfortably. 
